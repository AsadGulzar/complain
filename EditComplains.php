...
<section class="content-wraper">
	<div class="container">
    	<div class="row">
            ...
            <div class="col-sm-9">
            	<?php
					$GetComplainQ = "select * from complain where Status='Under Progress' and ComplainUserId='$UserID' order by ComplainId desc";
						...
						while($GetComplainRow = mysqli_fetch_assoc($GetComplainQR))
						{
							...
							<article>
								...
								<div class="bottom-article">
                                    ...
                                    <a href="EditAction.php?ComplainID=<?php echo $ComplainId;?>" class="readmore pull-right">Edit <i class="fa fa-angle-right"></i></a>
								</div>
							</article>
							<?php
							}
