            ...
            <div class="col-sm-9">
            	<?php
					...
					if(!isset($_GET['categoryId']))
					{
						...
						$GetComplainQ = "select * from complain order by ComplainId 
						desc limit $start,$limit";
						
						$GetComplainQR = mysqli_query($con,$GetComplainQ);
						
						$GetNumQ = mysqli_query($con,"select * from complain order 
						by ComplainId desc");
					...
					else
					{
						...
						$GetComplainQ = "select * from complain where 
						 ComplainCategoryID='$MHCategoyId' order by ComplainId 
						 desc limit $start,$limit";
						
						$GetComplainQR = mysqli_query($con,$GetComplainQ);
						
						$GetNumQ = mysqli_query($con,"select * from complain where 
						ComplainCategoryID='$MHCategoyId' order 
						by ComplainId desc");
                            ...
                            <nav>
                              <ul class="pagination">
                                ...
                                { 
                                    ?>
                                    <li>
                                      <a href="CategoryView.php?categoryId=<?php echo $MHCategoyId;?>&page=<?php echo $page-1;?>" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                      </a>
                                    </li>
                                    <?php 
                                ...
                                for($i=1;$i<=$total;$i++)
                                {
                                    ...
                                    <li><a href="CategoryView.php?categoryId=<?php echo $MHCategoyId;?>&page=<?php echo $i  ?>"><?php echo $i;?></a></li>    
                                    <?php
                                ...
                                { 
                                 ?>
                                <li>
                                  <a href="CategoryView.php?categoryId=<?php echo $MHCategoyId;?>&page=<?php echo $page+1; ?>" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                  </a>
                                </li>
                                <?php
