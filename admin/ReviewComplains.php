    	...
    	<div class="row">
            ...
            <div class="col-sm-9">
            	<?php
					...
					$GetComplainQ = "select * from complain where Status='Under Review'  order by ComplainId desc limit $start,$limit";
					$GetComplainQR = mysqli_query($con,$GetComplainQ);
					
					$GetNumQ = mysqli_query($con,"select * from complain where Status='Under Review'  order by ComplainId desc");
