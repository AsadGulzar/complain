		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="breadcrumb">
					...
					<li class="active">Solve Complains</li>
				</ul>
			</div>
		</div>
	</div>
    	...
    	<div class="row">
            ...
            <div class="col-sm-9">
            	<?php
					...
					$GetComplainQ = "select * from complain where Status='Completed'  order by ComplainId desc limit $start,$limit";
					
					$GetComplainQR = mysqli_query($con,$GetComplainQ);
					
					$GetNumQ = mysqli_query($con,"select * from complain where Status='Completed'  order by ComplainId desc");
