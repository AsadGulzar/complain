            ...
            <div class="col-sm-9">
            	<?php
					...
					if(!isset($_GET['categoryId']))
					{
						...
						$GetComplainQ = "select * from complain where ComplainUserId='$UserID'  order by ComplainId desc limit $start,$limit";
						
						$GetComplainQR = mysqli_query($con,$GetComplainQ);
						
						$GetNumQ = mysqli_query($con,"select * from complain where ComplainUserId='$UserID'  order by ComplainId desc");
                                    ...
                                    <div class="bottom-article">
                                        <ul class="meta-post">
                                            ...
                                            <?php
												...
												{
													?>
                                                    <li><i class="fa fa-heart"></i><a href="FeedBack.php?ComplainId=<?php echo $ComplainId;?>"> FeedBack</a></li>
													<?php
												}
                                            ?>
                                        </ul>
					...
					else
					{
						...
						$MHCategoyId = $_GET['categoryId'];
						
						$GetComplainQ = "select * from complain where ComplainUserId='$UserID' and ComplainCategoryID='$MHCategoyId' order by ComplainId desc limit $start,$limit";
						
						$GetComplainQR = mysqli_query($con,$GetComplainQ);
						
						$GetNumQ = mysqli_query($con,"select * from complain where ComplainUserId='$UserID' and ComplainCategoryID='$MHCategoyId' order by ComplainId desc");
                            ...
                            <nav>
                              <ul class="pagination">
                                ...
                                { 
                                    ?>
                                    <li>
                                      <a href="dashboard.php?categoryId=<?php echo $MHCategoyId;?>&page=<?php echo $page-1;?>" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                      </a>
                                    </li>
                                    <?php 
                                ...
                                for($i=1;$i<=$total;$i++)
                                {
                                    ...
                                    <li><a href="dashboard.php?categoryId=<?php echo $MHCategoyId;?>&page=<?php echo $i  ?>"><?php echo $i;?></a></li>    
                                    <?php
                                }
                                ...
                                { 
                                 ?>
                                <li>
                                  <a href="dashboard.php?categoryId=<?php echo $MHCategoyId;?>&page=<?php echo $page+1; ?>" aria-label="Next">
                                    <span aria-hidden="true">&raquo;</span>
                                  </a>
                                </li>
                                <?php
